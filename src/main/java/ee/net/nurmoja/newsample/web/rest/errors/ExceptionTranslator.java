package ee.net.nurmoja.newsample.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ee.net.nurmoja.newsample.service.EmailAlreadyUsedException ||
            ex instanceof ee.net.nurmoja.newsample.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof ee.net.nurmoja.newsample.service.InvalidPasswordException
